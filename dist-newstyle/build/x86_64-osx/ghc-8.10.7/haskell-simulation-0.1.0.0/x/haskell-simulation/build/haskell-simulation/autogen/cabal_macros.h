...
/* package haskell-simulation-0.1.0.0 */
#ifndef VERSION_haskell_simulation
#define VERSION_haskell_simulation "0.1.0.0"
#endif /* VERSION_haskell_simulation */
#ifndef MIN_VERSION_haskell_simulation
#define MIN_VERSION_haskell_simulation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_simulation */
...
#define CURRENT_COMPONENT_ID "haskell-simulation-0.1.0.0-inplace-haskell-simulation"
